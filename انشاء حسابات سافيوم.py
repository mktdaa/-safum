...
''')
	...
	print(X+"_"*67)
	print('')
	print(C+' ملاحظة / هذه النسخة بطيئه و مجانية للاستخدام الشخصي فقط ✓             ')
	print('للمزيد من الادوات انظم هنا                     ')
	print('')
	print(y+'                         @ssa_asrbot                ')
	print('')
	print(X+"_"*67)
	print('')
	print(BRed+'عدد الضغطات : '+str(failed))
	print('')
	
	print('')
	print(BCyan+'عدد الحسابات : '+str(created))
	print(F+'')